<div class="sidebar">
    ...
    <ul class="nav flex-column">
        ...
        <li class="nav-item">
            <a href="{{ url('superadmin/classes/list') }}"
               class="nav-link @if(Request::segment(2) == 'classes') active @endif">
                <i class="fa fa-theater-masks"></i> Classes
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ url('superadmin/enrollments/list') }}"
               class="nav-link @if(Request::segment(2) == 'enrollments') active @endif">
                <i class="fa fa-award"></i> Enrollments
            </a>
        </li>
        <li class="nav-item">
            <a href="{{ url('superadmin/payments/list') }}"
               class="nav-link @if(Request::segment(2) == 'payments') active @endif">
