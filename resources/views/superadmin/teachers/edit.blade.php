    ...
    <div class="col-md-12 mt-4">
        <div class="card p-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="mb-0">Edit / Update Teacher</h5>
            </div>
            <form action="{{ url('superadmin/teachers/edit/' . $getRecord->id) }}" id="itemForm" method="post">
                @csrf
                <div class="mb-3 row">
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input type="text" name="specialization" id="specialization" value="{{ $getRecord->specialization }}"
                ...
                <div class="mb-3 row">
                    ...
                    <div class="col-md-9">
                        <input type="date" name="joining_date" id="joining_date"
                               class="form-control" value="{{ $getRecord->joining_date }}">
                    </div>
                </div>
